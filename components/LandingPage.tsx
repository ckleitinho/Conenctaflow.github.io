      ...
      <header className="sticky top-0 z-50 bg-white/90 backdrop-blur-md border-b border-slate-200/80 transition-all">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 sm:h-20 flex items-center justify-between">
          ...
          <nav className="hidden md:flex items-center gap-8 text-sm font-medium text-slate-600">
            <a href="#recursos" className="hover:text-[#1877F2] transition-colors">
              Recursos
            </a>
            <a href="#demo" className="hover:text-[#1877F2] transition-colors">
              Demonstração
            </a>
            <a href="#beneficios" className="hover:text-[#1877F2] transition-colors">
              Benefícios
            </a>
            <a href="#github-io" className="hover:text-[#1877F2] transition-colors flex items-center gap-1.5">
              <Github className="w-4 h-4 text-slate-800" />
              <span>Hub github.io</span>
            </a>
            <a href="#depoimentos" className="hover:text-[#1877F2] transition-colors">
              Depoimentos
            </a>
          </nav>
